...
#define RB_OPUS_ENCODE_SIZE     (XZ_MIC_FRAME_LEN * 2)
#define XZ_SPK_WRITE_CACHE_SIZE 12000U
#define XZ_AUDIO_PSRAM_HEAP_SIZE (768 * 1024)
                                         ...
                                         rt_bool_t zero_pad_tail)
{
    ...
    if (thiz == RT_NULL || pcm_bytes == 0 || pcm_bytes > XZ_MIC_FRAME_LEN)
    {
        return;
    }
