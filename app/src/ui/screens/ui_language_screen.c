...
void ui_Language_screen_init(void)
{
    ...
    ui_create_button(panel, 44, 94, 440, 50, "简体中文", 20, UI_SCREEN_NONE, true);
    ui_create_button(panel, 44, 154, 440, 50, "English", 20, UI_SCREEN_NONE, false);
    ui_create_button(panel, 44, 214, 440, 50, "日本語", 20, UI_SCREEN_NONE, false);
}
